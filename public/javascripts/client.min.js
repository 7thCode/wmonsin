var app=angular.module("TopApplication",["ui.router","TopControllers"]);app.config(["$stateProvider","$urlRouterProvider","$compileProvider","$httpProvider",function(e,r,t,o){t.debugInfoEnabled(!1),o.defaults.headers.common={"x-requested-with":"XMLHttpRequest"},e.state("start",{url:"/",templateUrl:"partials/logo",controller:"TopController"}),r.otherwise("/")}]),app.filter("message",function(){return function(e){var r="?????";switch(e){case"front":r="問診票";break;case"stuff":r="スタッフ"}return r}});
